    ...
    return (
      <div className={ this.props.viewModel.navBarExpanded ? "menu-container" : "menu-container-shrinked"}>
        ...
        <div className="menu-logo">
          ...
          <MenuItem href="/"><div className={ this.props.viewModel.navBarExpanded ? "menu-bar-icon" : "menu-bar-icon-shrinked"}><FontAwesomeIcon icon="clipboard-list" /></div><div className={ this.props.viewModel.navBarExpanded ? "menu-text-visible" : "menu-text-hidden" }>Listen</div></MenuItem>
